...
namespace Weather.API.Features.Favorites.Queries
{
    internal sealed class GetFavoritesHandler : IGetFavoritesHandler
    {
        ...
        private readonly IFavoritesQueriesRepository _weatherQueriesRepository;
        private readonly IWeatherService _weatherService;
        private readonly ILogger<IGetFavoritesHandler> _logger;

        public GetFavoritesHandler(IFavoritesQueriesRepository weatherQueriesRepository,
